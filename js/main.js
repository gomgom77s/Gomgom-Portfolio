...
const MODALS = {
 ...
 data7: {
    type: 'Data Analytics', color: 'var(--data)',
    title: 'Analyzing & Evaluating Sales Funnel Evaluation',
    tools: ['Spreadsheet', 'Python'],
    location: 'RevoU — Full Stack Data Analytics',
    scope: {
      dataset: 'PeopleU – B2B SaaS Sales Funnel',  
      industry: 'B2B SaaS',
      duration: '1 week',
      role: 'Data Analyst',
      source: 'PeopleU Sales, Marketing & Customer Data',
      rows: '34,187 rows',
    },
    background: 'Currently, the focus of PeopleU is to increase its customer with several initiatives such as evaluating the marketings and acquisition process, also considering offering price packages. Experts, as the person in charge, tries to guide the DA team to provide the proper evaluation and advice regarding how data can be used to provide analysis to support those initiatives.',
    processLabels: ['Raw Dataset', 'Data Cleaning & Transformation'],
    hero: { img: 'images/portfolio-analytics-7a.jpg', caption: 'Diesshop Monitoring Diesboard' },
    workflow: ['Data Extraction', 'Data Cleaning', 'EDA', 'Customer Segmentation (Python)', 'Insight & Recommendation'],
    sql: { img: 'images/portfolio-analytics-7b.jpg', caption: 'Python was used to validate the relationship between funnel Deal Won and new contracts' },
    ...
    deckUrl: 'https://docs.google.com/presentation/d/15gbbZFcflmU-wBKw30mq1k5-QSiSNn6Qzz_PEyMp6_Q/edit?usp=drive_link',
 },
 data8: {
    type: 'Data Analytics', color: 'var(--data)',
    title: 'RevoFin Loan Portfolio Risk Analysis ',
    tools: ['Spreadsheet', 'SQL'],
    location: 'RevoU — Full Stack Data Analytics',
    scope: {
      dataset: 'RevoFin Loan Portfolio Dataset',  
      industry: 'Fintech / Online Lending',
      duration: '1 week',
      role: 'Data Analyst',
      source: 'RevoFin Portfolio Data',
      rows: '270,299 loan records + 270,299 customer records',
    },
    background: 'RevoFin operates an online lending portfolio where portfolio growth must be balanced with repayment performance. Risk Management needs to understand where portfolio risk is concentrated and which borrower or loan characteristics are associated with weaker repayment outcomes. ',
    processLabels: ['Raw Dataset', 'Data Cleaning & Transformation'],
    hero: { img: 'images/portfolio-analytics-8a.jpg', caption: 'Analyzed the recorded failure reasons across the top three small-company segments to identify the main patterns behind funnel leakage' },
    workflow: ['Data Extraction', 'Data Cleaning', 'EDA', 'Customer Segmentation (SQL)', 'Insight & Recommendation'],
    sql: { img: 'images/portfolio-analytics-8b.jpg', caption: 'SQL-based data preparation to extract and transform key customer attributes used for cohort profiling and segmentation analysis' },
    ...
    recommendation: 'Improve pricing communication by clearly communicating package value and pricing to address price-fit concerns. - Strengthen early lead qualification to better identify customer needs and interest before Sales follow-up. - Implement structured follow-up and re-engagement to improve response rates, particularly among Technology small-business leads.',
    deckUrl: 'https://docs.google.com/presentation/d/1T2CR8KvfA9hzJ3qnBh34HohNvrH9l5UocgEvXCW1FUw/edit?usp=drive_link',
},
};
